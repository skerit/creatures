...
Egg.setMethod(function getParent(type, callback) {
	return Creatures.Creature.prototype.getParent.call(this, type, callback);
});
 ...
 * @param    {Function} callback
 */
Egg.setMethod(function loadHistory(callback) {
	return Creatures.Creature.prototype.loadHistory.call(this, callback);
});
 ...
 * @param    {Function} callback
 */
Egg.setMethod(function loadHistoryFiles(callback) {
	return Creatures.Creature.prototype.loadHistoryFiles.call(this, callback);
});
