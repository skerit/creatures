...
/**
 * Get the value of the wanted chemical
 *
 * @author   Jelle De Loecker   <jelle@develry.be>
 * @since    0.2.1
 * @version  0.2.1
 ...
 *
 * @return   {Number}   The concentration of this chemical, from 0-255
 */
Chemistry.setMethod(function getValue(id) {

	var chemical;

	if (typeof id == 'number') {
		chemical = this.chemicals[id];
	} else {
		chemical = Blast.Bound.Array.findByPath(this.chemicals, 'name', id);
	}
