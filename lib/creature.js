...
Creature.setMethod(function loadByMoniker(moniker, callback) {
	...
	if (moniker.charCodeAt(0) == 0) {
		console.log('Creature', this, 'has no valid moniker')
...
Creature.setAfterMethod('ready', function getBodyPartImage(part_name, callback) {
	...
	console.log(this.name, 'is species', gene.data.species, gene);

	console.log('AGEN is:', that.agen);
	...
	console.log('Creature', this.name, part_name, 's16 should be', filename);
